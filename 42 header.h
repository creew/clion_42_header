...
##/*   $FILE_NAME                                         :+:      :+:    :+:   */
##/*                                                    +:+ +:+         +:+     */
##/*   By: $USER_NAME <marvin@42.fr>                  +#+  +:+       +#+        */
##/*                                                +#+#+#+#+#+   +#+           */
##/*   Created: 2019/09/03 09:48:17 by $USER_NAME        #+#    #+#             */
##/*   Updated: 2019/10/06 17:36:48 by $USER_NAME       ###   ########.fr       */
##/*                                                                            */
##/* ************************************************************************** */
#set( $empty =  "                                                                                " )
#set( $l_111 =  "/* ************************************************************************** */" )
...
#if ( $l6_length > 42 )
    #set ( $uemail_length = 42 - 3 - 3 - $uname_length )
    #set ( $uemail = "$uemail.substring(0, uemail_length)...")
    #set ( $uemail_length = $uemail_length + 3)
#end
